...
import 'package:heart_link_app/screens/session/session_type_screen.dart';
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/sessionType': (context) {
          ...
          return SessionTypeScreen(workoutMode: args['workoutMode'] as String);
        },
        '/sensorSelection': (context) {
          ...
          return SensorSelectionScreen(
            ...
            sessionType: (args['sessionType'] as String?) ?? 'create',
          );
        },
        ...
        '/radialGauge': (context) {
          ...
          return GaugeChart(
            ...
            workoutMode: args['workoutMode'] as String,
            sessionType: (args['sessionType'] as String?) ?? 'paired',
          );
        },
